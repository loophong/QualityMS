export function FinModel(id_, fid_, name_, upOrDown_, fontColor_, lineColor_, link_) {
  this.id_ = id_;
  this.fid_ = fid_;
  this.name_ = name_;
  this.finLength_ = "";
  ...
  this.toString = function () {
    return "id:[" + this.id_ + "]   ;fid:[" + this.fid_ + "]    ;name:[" + this.name_ + "]    ;level:" + this.level_ + "   ;upOrDown:" + this.upOrDown_ + "   ;leaf:" + this.leaf_ + "   ;NextLevelCount:" + this.nextLevelCount_ + "   ;nameLength:" + this.nameLength_ + "   ;finLength_:" + this.finLength_ + "   ;NextLevelMaxLength_:" + this.nextLevelMaxLength_ + "   ;NextLevel2MaxLength_:" + this.nextLevel2MaxLength_ + "   ;finTeam_:" + this.finTeam_ + "  ; rotate_" + this.rotate_ + "  ;fromNodePosition_" + this.fromNodePosition_ + "  ;toNodePosition_" + this.toNodePosition_ + "  ;childrenNode_" + this.childrenNode_ + " <br> "
  }
}
