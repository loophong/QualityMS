...
import {FinModel} from '@/components/fishbone/FinModel'
import {Map_} from '@/components/fishbone/Map'
import {showJTopoToobar} from './toolbar'
import head from '@/components/fishbone/theme/default/image/head.svg'
import body from '@/components/fishbone/theme/default/image/body.svg'
import tail from '@/components/fishbone/theme/default/image/tail.svg'
...
export class FishBones {
  ...
  initNextLevelCount() {
    console.log('initNextLevelCount1111')
...
//                            break;
    ...
    console.log('initNextLevelCount2222')
  }
