<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
      ...
      <el-table-column prop="qcExamineSubject" header-align="center" align="center" label="审核关联课题">
      </el-table-column>
      <el-table-column prop="qcExamineStatus" header-align="center" align="center" label="审核进行步骤">
      </el-table-column>
      ...
      <el-table-column prop="qcSevenContent" header-align="center" align="center" label="">
      </el-table-column>
      <el-table-column prop="qcSixContent" header-align="center" align="center" label="">
      </el-table-column>
      <el-table-column prop="qcFiveContent" header-align="center" align="center" label="">
      </el-table-column>
      <el-table-column prop="qcSecondScore" header-align="center" align="center" label="成果复评分数">
      </el-table-column>
      <el-table-column prop="qcFourContent" header-align="center" align="center" label="">
      </el-table-column>
      <el-table-column prop="qcFirstScore" header-align="center" align="center" label="成果初评分数">
      </el-table-column>
      <el-table-column prop="qcThreeContent" header-align="center" align="center" label="">
      </el-table-column>
      <el-table-column prop="qcTwoContent" header-align="center" align="center" label="">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl('/indicator/qcexaminestatus/list'),
        method: 'get',
