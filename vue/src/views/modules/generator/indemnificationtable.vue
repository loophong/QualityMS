  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('generator:indemnificationtable:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('generator:indemnificationtable:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
      <el-form-item>
...
<!--      </el-table-column>-->
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.indeId)">修改</el-button>
          <el-button type="text" size="small" @click="deleteHandle(scope.row.indeId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
<script>
  import AddOrUpdate from './indemnificationtable-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      beforeUpload(file) {
        ...
        // 开始上传请求
        this.$http({
          url: this.$http.adornUrl('/generator/indemnificationtable/uploadExcel'),
          method: 'post',
          data: formData,
          headers: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/indemnificationtable/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/indemnificationtable/delete'),
            method: 'post',
