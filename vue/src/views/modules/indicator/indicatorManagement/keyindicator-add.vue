<template>
  <el-dialog
    :title="!dataForm.indicatorId ? '新增' : '重点管控'"
...
export default {
  ...
  methods: {
    ...
    init (id) {
      ...
      console.log("dataForm.IndicatorId====>",this.dataForm.indicatorId)
      this.visible = true
      this.$nextTick(() => {
        this.$refs['dataForm'].resetFields()
        if (this.dataForm.indicatorId) {
          console.log("dataForm.IndicatorId123====>",this.dataForm.indicatorId)
          this.$http({
            ...
            if (data && data.code === 0) {
              ...
              this.dataForm.sourceDepartment = data.indicatorDictionary.managementDepartment
