  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('notice:messagenotification:save')" type="primary" @click="addOrUpdateHandle()">
          新增
        </el-button>
        <el-button v-if="isAuth('notice:messagenotification:delete')" type="danger" @click="deleteHandle()"
...
<!--      <el-table-column prop="id" header-align="center" align="center" label="主键"></el-table-column>-->
      ...
      <!--      <el-table-column prop="status" header-align="center" align="center" label="消息状态"></el-table-column>-->
      <el-table-column prop="status" label="消息状态" header-align="center" align="center">
        <template slot-scope="scope">
          <span v-if="scope.row.status === 'UNREAD'">
                <el-tag type="info" disable-transitions>未读</el-tag></span>
          <span v-else-if="scope.row.status === 'READ'">
                <el-tag type="success" disable-transitions>已读</el-tag></span>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          ...
          <!--    如果状态为未读，则显示已读按钮      -->
          <el-button v-if="scope.row.status === 'UNREAD'" type="text" size="small" @click="readNotice(scope.row.id, scope.row.jumpdepart)">执行</el-button>
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl('/notice/mine'),
        method: 'get',
