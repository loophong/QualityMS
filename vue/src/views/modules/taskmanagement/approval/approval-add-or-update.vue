<template>
  <el-dialog :title="!dataForm.approvalId ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item label="任务送审时间" prop="taskSubmissionTime">
        <el-input v-model="dataForm.taskSubmissionTime" placeholder="任务送审时间"></el-input>
      </el-form-item>
