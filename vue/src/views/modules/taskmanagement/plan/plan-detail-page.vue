        ...
        <el-container>
            <el-main>
                ...
                <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="计划编号" prop="planId">
                                <el-input v-model="dataForm.planId" disabled placeholder="计划编号"
                                    @blur="checkPlanNumber"></el-input>
                            </el-form-item>
                        ...
                        <el-col :span="12">
                            ...
                            <el-form-item label="计划完成日期" prop="planScheduleCompletionDate">
                                <el-date-picker v-model="dataForm.planScheduleCompletionDate" type="date"
                                    placeholder="选择计划完成日期" style="width: 100%;"></el-date-picker>
                            </el-form-item>
                            ...
                            <!-- <el-form-item label="是否完成" prop="planIsCompleted">
                                <el-input v-model="dataForm.planIsCompleted" placeholder="是否完成"></el-input>
                            </el-form-item> -->
                            <!-- <el-form-item label="是否超期" prop="planIsOverdue">
                                <el-input v-model="dataForm.planIsOverdue" placeholder="是否超期"></el-input>
                            </el-form-item>
                            <el-form-item label="按时完工" prop="planIsOnTime">
                                <el-input v-model="dataForm.planIsOnTime" placeholder="按时完工"></el-input>
                            </el-form-item> -->                            
                            <el-form-item label="是否完成" prop="planIsCompleted">
                                <el-select v-model="dataForm.planIsCompleted" placeholder="是否完成">
                                    <el-option v-for="item in isStatus" :key="item.value" :label="item.label"
                                        :value="item.value">
                                    </el-option>
                                </el-select>
                            </el-form-item>
                    ...
                    <!-- 任务列表 -->
                    <div v-for="(task, index) in tasks" :key="index" style="background-color:#EEEEEE;"
                      ...
                      <el-input v-model="task.principal" placeholder="负责人"></el-input>
                                ...
                                <el-col :span="12">
                                    ...
                                    <el-form-item label="预计完成日期" prop="taskScheduleCompletionDate">
                                        <el-date-picker v-model="task.taskScheduleCompletionDate" type="date"
                                            placeholder="选择任务完成日期" style="width: 100%;"></el-date-picker>
                                    </el-form-item>
